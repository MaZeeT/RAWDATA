...
public class AnnotationTestsContainers : IClassFixture<IntegrationTestWebApplicationFactory>, IAsyncLifetime
{
    private readonly WebApplicationFactory<Program> _factory;
    private HttpClient _httpClient = null!;
    
    public AnnotationTestsContainers(WebApplicationFactory<Program> factory)
    {
        _factory = factory;
    }
