...
public class AnnotationTestsTestContainerDb : IClassFixture<IntegrationTestWebApplicationFactory>
{
    ...
    public AnnotationTestsTestContainerDb(IntegrationTestWebApplicationFactory factory)
    {
